...
const HotelDetailScreen = ({navigation, route}) => {
  ...
  const onHandlePress = (item) => {
    navigation.navigate('RoomScreen', {itemprops :item})
  ...
  return (
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={{width:"100%",height:100,borderBottomRightRadius:16}}>
      <Image source={{uri:itemprops.url}} style={styles.image4} />
             <TouchableOpacity onPress={openGallery} style={styles.transparentOverlay}>
  ...
  <Overview></Overview>
   <HotelLocation latitude={itemprops.latitude} longitude={itemprops.longitude}></HotelLocation>

    </ScrollView>
    <Pressable style={{width:"100%",height:50,justifyContent:"center",alignItems:"center",borderRadius:10,position:"absolute",bottom:10,padding:10}}
    onPress={onHandlePress}>
    <View style={{backgroundColor:"#37B5B6",width:"100%",height:50,justifyContent:"center",alignItems:"center",borderRadius:10,position:"absolute"}}>
    <Text style={{color:"white",textAlign:"center",fontSize:20}}>Select Room</Text>
    </View>
   </Pressable>
    </>
  )
